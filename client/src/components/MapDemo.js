...
const MapDemo = () => {
  ...
  useEffect(() => {
    ...
    const vehicles = [
      ...
      },
      {
        ...
        vehicleId: 'CAR002',
        currentLocation: {
          latitude: 40.7128 + 0.00002, // ~2m from CAR001 (collision risk <3m)
      ...
      },
      {
        ...
        vehicleId: 'CAR003',
        currentLocation: {
          latitude: 40.7128 + 0.00004, // ~4m from CAR001 (warning zone 3-5m)
  ...
  return (
    <div style={{ padding: '20px' }}>
      ...
      <ul>
        <li><strong>Green markers:</strong> Safe distance (&gt;5m)</li>
        <li><strong>Yellow markers:</strong> Warning zone (3-5m)</li>
        <li><strong>Red markers:</strong> Collision risk (&lt;3m)</li>
      </ul>
